    ...
    <header className="text-gray-600 body-font relative">
      <div className="container mx-auto flex flex-wrap p-2 flex-col md:flex-row items-center">
        ...
        <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
          <Link legacyBehavior className="mr-5 hover:text-gray-900" href="/clientes" passHref>
            Experiencia
          </Link>
          <Link legacyBehavior className="mr-5 hover:text-gray-900" href="/producto" passHref>
            Planes y Precios
          </Link>
          <Link legacyBehavior className="mr-5 hover:text-gray-900" href="/sobre" passHref>
            Sobre
          </Link>
          {/* Nuevo enlace para Servicios Empresariales */}
          <Link legacyBehavior className="mr-5 hover:text-gray-900" href="/empresariales/bateria-de-riesgo-psicosocial" passHref>
